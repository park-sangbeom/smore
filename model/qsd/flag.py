...
def build_flag():
    ...
    parser.add_argument("--env", default="place")   #Reacher-v2 #Hopper-v2 #sweep
    parser.add_argument("--env_name", default="place")
    parser.add_argument("--seed", default=0, type=int) #0 #1  #2  #3    
    ...
    parser.add_argument("--loss_weight_lambda", default=5, type=float)    
    parser.add_argument("--exp_name", default="weights/qsd") 
    parser.add_argument("--device", default="cuda:0") 
    parser.add_argument("--lr", default=1e-3, type=float) 
    parser.add_argument("--reward_threshold_to_guide", default=0.8, type=float)
    parser.add_argument("--traj_len", default=1, type=int)
