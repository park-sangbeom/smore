...
from model.utils.sampler import kdpp, ikdpp, laqdpp
from model.utils.utils import reward_nzr
...
class BufferClass:
    ...
    def sample_batch(self, sample_method="random", batch_size=128):    
        ...
        elif sample_method == 'laqdpp':
            _, idxs = laqdpp(xs_total=self.x, qs_total=self.reward, n_select=batch_size)
        else: # Random 
